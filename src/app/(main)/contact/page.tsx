    ...
    <div>
      <div className="prose prose-gray max-w-none">
        ...
        <div className="flex flex-wrap gap-4 justify-start">
          <a
            href="mailto:angusqweas@gmail.com"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center text-gray-600 hover:text-blue-700 transition-colors"
          >
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="https://medium.com/@anguszhang"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center text-gray-600 hover:text-gray-900 transition-colors"
          >
